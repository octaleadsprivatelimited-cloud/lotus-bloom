      ...
      <AnimatePresence>
        {showPopup && (
          <motion.div
            ...
            className="mb-4 bg-white rounded-3xl shadow-2xl border border-slate-100 p-5 w-[calc(100vw-3rem)] max-w-[320px] sm:w-80 relative origin-bottom-right"
          >
            <button
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-[#25D366]/10 rounded-full flex shrink-0 items-center justify-center text-[#25D366]">
            ...
            <div className="bg-slate-50 rounded-2xl rounded-tl-sm p-4 text-sm text-slate-700 relative border border-slate-100 shadow-sm mt-2">
              <p className="leading-relaxed">Hi there! 👋 How can we help you today?</p>
            </div>
            <button
              onClick={handleWhatsAppClick}
              className="mt-5 w-full bg-[#25D366] hover:bg-[#1DA851] shadow-lg shadow-[#25D366]/30 text-white font-bold py-3 px-5 rounded-full transition-all active:scale-95 flex items-center justify-center gap-2 text-sm"
            >
              Start Chat
            </button>
          </motion.div>
